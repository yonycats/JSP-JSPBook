                    ...
                    <div class="content-left wow fadeInLeft" data-wow-delay=".3s">
						...
						<%
							...
							while ( paramNames.hasMoreElements() ) {
								...
								// nextElement() : Enumeration 요소를 반환함
								// 폼 페이지에서 전송된 요청 파라미터의 이름을 가져옴(name)
								...
								// name이 hobby인 요소는 같은 name의 데이터가 여러개이므로 별도의 처리로 진행한다.
								// getParameterValues("hobby")로 값을 꺼내면 여러개의 데이터를 한꺼번에 배열로 받을 수 있다.
